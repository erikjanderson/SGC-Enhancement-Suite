...
**System Properties**: You can find these by going to **SGC Enhancement Suite** > **Settings** in the filter navigator.
 ...
 - **Max Processing Rows**: Limit the number of rows that are either loaded or processed when using the SGC Enhancement Suite. If left empty, no limit will be enforced.
